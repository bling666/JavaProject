...
public class Processor{
    public static String[] ReadAndToken(String filepath) throws IOException{
        //读取停用词表
        List<String> stopwords =  Files.readAllLines(Paths.get("D:\\Sophomore2\\java_project\\stopwords.txt"));
        //读取文件
